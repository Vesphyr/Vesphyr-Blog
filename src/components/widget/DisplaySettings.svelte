<script lang="ts">
  ...
  const colorOptions = [
    { hue: 0, name: "御绯红", color: "oklch(0.42 0.12 0)" },
    { hue: 150, name: "翠微绿", color: "oklch(0.42 0.10 150)" },
    { hue: 265, name: "琉璃蓝", color: "oklch(0.42 0.10 265)" },
    { hue: 325, name: "皇家紫", color: "oklch(0.42 0.11 325)" },
  ];
